...
//       // fetch(`https://aceleracion.herokuapp.com/api/contacts`, { // use local, comment when pushing to heroku
//       fetch(`${env.REACT_APP_API_URL}/contacts`, { // comment local, use when pushing to heroku
//         headers: {
